...
public class RetrofitConfiguration {
    ...
    @Bean
    public RabbitMQConnectionService rabbitMqServiceRequest(Retrofit.Builder secureKeyBuilder,
                                                            @Value("${rabbitmq.service.url}") String baseUrl) {
        return secureKeyBuilder
                .baseUrl(baseUrl)
                .build()
                .create(RabbitMQConnectionService.class);
    }
